    ...
    <main className="min-h-screen bg-[#f6f7f2] px-4 py-6 text-[#151914] md:px-8">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-6 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <div>
            <p className="text-sm font-semibold uppercase tracking-[0.18em] text-[#47685d]">Runbook library</p>
            <h1 className="mt-2 text-4xl font-semibold tracking-tight">Turn trusted playbooks into agent workflows.</h1>
            <p className="mt-3 max-w-2xl text-sm leading-6 text-black/56">
              Install governed IT runbooks with matching workflow graphs, policy guardrails, and audit visibility.
            </p>
          </div>
          <Link
