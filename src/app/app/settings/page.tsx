    ...
    <main className="min-h-screen bg-[#f6f7f2] px-4 py-6 text-[#151914] md:px-8">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-6 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <div>
            <p className="text-sm font-semibold uppercase tracking-[0.18em] text-[#47685d]">Settings</p>
            <h1 className="mt-2 text-3xl font-semibold tracking-tight md:text-4xl">Workspace controls.</h1>
          </div>
          <Link
            href="/app/audit"
