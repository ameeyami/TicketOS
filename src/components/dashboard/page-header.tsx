...
export function PageHeader({
  ...
  return (
    <div className="mb-6 flex flex-col gap-3 border-b border-black/[0.06] pb-5 md:flex-row md:items-center md:justify-between">
      <div className="min-w-0">
        {crumbs.length > 0 && (
          <nav className="mb-1.5 flex flex-wrap items-center gap-1 text-xs font-medium text-slate-400">
        ...
        <h1 className="truncate text-xl font-semibold tracking-tight text-[#0b1a2e] md:text-2xl">{title}</h1>
